...
# read--> total content
# readline--> single line(1st line)
#readlines --> total data in list format (list of substrings)


# mode = 'a'
# file = open("demo.txt", mode = 'a')
# write_data = file.write("\nwrite operations performed by using mode = 'a")
# file.close()


#mode = 'a'
# file = open("demo1.txt",mode = 'a')
# write_data = file.write("write operations performed by using mode = 'a'\n")
# file.close()
...
# import os
# os.remove("demo1.txt")
# os.remove("demo12.txt")
# os.remove("sample1.txt")
# os.remove("sample.txt")


# file = open("C:\\Users\\tarak\\Desktop\\pythonlife1234.txt",mode = 'r')
# read_data = file.read()
# print(read_data)
# file.close()
